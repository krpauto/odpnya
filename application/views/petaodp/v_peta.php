...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-edit" style="color:green"> </i> Peta Data Pelangan
        </h1>
        <ol class="breadcrumb">
                            ...
                            <div class="form-inline row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="keyword" class="form-control">
                                        <?php foreach ($daftar_odp as $dop) { ?>
                                            <option value="<?= $dop['nama']; ?>"><?= $dop['nama']; ?></option>
                                        <?php } ?>
                                    </select>
...
<script>
    ...
    <?php foreach ($odp as $o) { ?>
        L.marker([<?= $o->latitude ?>, <?= $o->longitude ?>], {
            ...
            Swal.fire({
                imageUrl: '<?= base_url('assets_style/file/' .  $o->foto) ?>',
                title: '<span class="text-uppercase">Nama Pelanggan : <?= $o->nama ?></span>',
                html: "Alamat : <?= $o->alamat ?><br> Pro : <?= $o->luas ?> ha",
                imageHeight: 180,
