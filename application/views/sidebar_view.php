...
<aside class="main-sidebar skin-green">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      <?php if ($this->session->userdata('level') == 'Admin PTI') { ?>
        ...
        <li class="<?php if ($this->uri->uri_string() == 'letakodp') {
                      echo 'active';
                    } ?>">
          <a href="<?php echo base_url('letakodp'); ?>">
            <i class="fa fa-light"></i> <span>Peta ODP</span>
          </a>
        </li>
        ...
        <li class="<?php if ($this->uri->uri_string() == 'odp') {
                      echo 'active';
                    } ?>
        <?php if ($this->uri->uri_string() == 'odp/tambah') {
          echo 'active';
        } ?>
        <?php if ($this->uri->uri_string() == 'odp/edit/' . $this->uri->segment('3')) {
          echo 'active';
        } ?>">
          <a href="<?php echo base_url('odp'); ?>" class="cursor">
            <i class="fa fa-feed"></i> <span>Data ODP</span></a>
        </li>
      <?php } ?>
  ...
  <?php if ($this->session->userdata('level') == 'Ops sawit') { ?>
    ...
    <li class="<?php if ($this->uri->uri_string() == 'petaodp') {
                  echo 'active';
                } ?>">
      <a href="<?php echo base_url('petaodp'); ?>">
        <i class="fa fa-map"></i> <span>Odp</span>
      </a>
    </li>
    <li class="<?php if ($this->uri->uri_string() == 'laporan') {
                  echo 'active';
