...
class M_Admin extends CI_Model
{
  ...
  function get_table_opssawit_user()
  {
    $this->db->where('gis_odp.nama_odp', $this->session->userdata('asal_odp'));
    return $this->db->get('gis_odp')->result();
  }
  ...
  public function get_odp_keyword($keyword)
  {
    $this->db->select('*');
    $this->db->from('gis_odp');
